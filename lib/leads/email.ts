...
export function buildAdminLeadEmail(data: LeadPayload) {
  return {
    subject: `🟢 Isapres Premium Cotización de Isapre de la web — ${data.nombreApellido}`,
    html: `
      <div style="font-family:Arial,Helvetica,sans-serif;max-width:640px;margin:0 auto;color:#18181b;">
        <h1 style="color:#064e45;font-size:22px;margin:0 0 8px;">Nuevo lead</h1>
        <p style="margin:0 0 20px;color:#52525b;">Llegó una cotización desde el formulario de Isapres Premium.</p>
...
export function buildClientLeadEmail(data: LeadPayload) {
  ...
  return {
    subject: "🟢 Recibimos tu cotización — Isapres Premium",
    html: `
      <div style="font-family:Arial,Helvetica,sans-serif;max-width:640px;margin:0 auto;color:#18181b;">
        ...
        <p style="margin:0 0 12px;color:#52525b;line-height:1.6;">
          Recibimos tu solicitud de cotización. Un asesor de <strong>Isapres Premium</strong>
          revisará tus datos y te contactará pronto según tu preferencia
        ...
        <div style="padding:16px;border-radius:12px;background:#ecfdf5;color:#064e45;">
          <p style="margin:0;font-weight:700;">Resumen de tu cotización</p>
        </div>
