    ...
    <div className="fixed bottom-6 right-6 z-[70] sm:bottom-8 sm:right-8">
      {!reducedMotion && (
        <>
          ...
          />
          <span
            className="whatsapp-pulse whatsapp-pulse-delay absolute inset-0 rounded-full bg-[#25D366]"
            aria-hidden="true"
          />
        </>
      )}
      ...
      <motion.a
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/40 transition-shadow hover:shadow-xl hover:shadow-[#25D366]/50 sm:h-16 sm:w-16"
      >
